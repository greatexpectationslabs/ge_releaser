...
- This error occurs when you do not have sufficient permissions to push a tag to the repository. You must be added to the open source core group which gives you maintainer permissions.
